...
public class UserController  {
	...
	public User foo(Principal principal) {
	  ...
	  System.out.println("Real User password:"+realUser.getPassword());
    ...
    public User create(@RequestBody UserRequested userreq ) {
		...
		System.out.println("before bcyrpt "+password);
		System.out.println("after bycrpt "+encodedPassword);
